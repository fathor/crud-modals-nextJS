...
export default function UpdateProduct(product: Product) {
    ...
    return (
        <div>
            <button className="btn btn-primary btn-sm" onClick={handleChange}>Edit</button>
            <input type="checkbox" className="modal-toggle" checked={modal} onChange={handleChange} />
            <div className="modal">
                <div className="modal-box">
                    <h3 className="font-bold text-lg">Form Update {product.title}</h3>
                    <form onSubmit={handleUpdate}>
                        ...
                        <div className="modal-action">
                            ...
                            {!isMutating ? <button type="submit" className="btn btn-primary">Update</button> : <button type="button" className="btn loading">Updating...</button>}
                        </div>
                    </form>
                </div>
            </div>
